 ...
 * - Timer:
 *      Provide a way of measuring time between 2 points and then getting this time.
 *      it also defines a MACRO  GEDO_TIME_BLOCK(BlockName) that can be used to measure the current block.
 */
...
namespace gedo
{
    ...
    */
    ...
    struct Array
    {
        ...
        T *data() { return (T *)block.data; }
        const T *data() const { return (const T *)block.data; }
    ...
    //---------------------IO-------------------------------------//
    // utf8 text.
    GEDO_DEF void PrintToConsole(const char* text, Color c = WHITE);
...
#define GEDO_TIME_BLOCK(BlockName)                                                        \
  ...
  defer({                                                                      \
    ...
    //------------------------IO-------------------------------//
    void PrintToConsole(const char* text, Color c)
    {
